    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://telegra.ph/file/f8f7db89a81d15a7691c0.png",
        ...
        try:
            ...
            mm = [
                InlineQueryResultArticle(
                    ...
                    thumb_url="https://telegra.ph/file/0103ad38f741727f01558.png",
                    reply_markup=switch_btn
                )
            ]
...
async def whispes_cb(_, query):
    ...
    if user_id not in [from_user, to_user, 6717522366]:
        try:
